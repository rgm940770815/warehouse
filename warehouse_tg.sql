/*
 ...
 Source Schema         : warehouse_tg

 Target Server Type    : MySQL
 Target Server Version : 50742
 File Encoding         : 65001

 Date: 18/10/2023 00:23:49
*/
...
-- ----------------------------
INSERT INTO `bus_customer` VALUES (14, '谭桂', '13888888888@163.com', '石柱', '13888888888', '谭桂', '13888888888', '中国银行', '88888888888', '13888888888@163.com', '02388888888', 1, 0, NULL);
...
-- ----------------------------
INSERT INTO `bus_goods` VALUES (21, '底料', 13, '石柱县', '123456', '123cc', '20230909', '123cc323', '涂料粉-底料', 100, 89, 100, '2023-10-14/A398BEBBE52A45E6B0DA48D67E1F18CF.jpg', 1, 0, NULL);
INSERT INTO `bus_goods` VALUES (25, '面料', 13, '石柱县', '123456', '123cc', '20230909', '123cc323', '涂料粉-面料', 100, 0, 100, '2023-10-14/A398BEBBE52A45E6B0DA48D67E1F18CF.jpg', 1, 0, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品进货表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bus_inport
-- ----------------------------
INSERT INTO `bus_inport` VALUES (22, '支付宝', '2023-10-17 14:27:26', '超级管理员', 100, '', 11, 13, 21, 0, NULL);
...
CREATE TABLE `bus_provider`  (
  ...
  `deletetime` datetime(0) NULL DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '供应商表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `bus_sales`  (
  ...
  `deletetime` datetime(0) NULL DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品销售表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bus_sales
-- ----------------------------
INSERT INTO `bus_sales` VALUES (27, 14, '支付宝', '2023-10-17 15:57:11', '超级管理员', 11, '', 11.00, 21, 25, 0, NULL);
...
CREATE TABLE `sys_loginfo`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 388 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录日志记录表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_loginfo` VALUES (375, '超级管理员-system', '127.0.0.1', '2023-10-17 04:14:29');
INSERT INTO `sys_loginfo` VALUES (376, '超级管理员-system', '127.0.0.1', '2023-10-17 04:45:12');
INSERT INTO `sys_loginfo` VALUES (377, '超级管理员-system', '127.0.0.1', '2023-10-17 05:04:18');
INSERT INTO `sys_loginfo` VALUES (378, '超级管理员-system', '127.0.0.1', '2023-10-17 09:05:54');
INSERT INTO `sys_loginfo` VALUES (379, '超级管理员-system', '127.0.0.1', '2023-10-17 09:58:21');
INSERT INTO `sys_loginfo` VALUES (380, '超级管理员-system', '127.0.0.1', '2023-10-17 12:33:37');
INSERT INTO `sys_loginfo` VALUES (381, '超级管理员-system', '127.0.0.1', '2023-10-17 14:12:26');
INSERT INTO `sys_loginfo` VALUES (382, '超级管理员-system', '127.0.0.1', '2023-10-17 14:26:21');
INSERT INTO `sys_loginfo` VALUES (383, '超级管理员-system', '127.0.0.1', '2023-10-17 14:29:18');
INSERT INTO `sys_loginfo` VALUES (384, '超级管理员-system', '127.0.0.1', '2023-10-17 14:34:26');
INSERT INTO `sys_loginfo` VALUES (385, '超级管理员-system', '127.0.0.1', '2023-10-17 14:52:56');
INSERT INTO `sys_loginfo` VALUES (386, '超级管理员-system', '104.28.153.21', '2023-10-17 15:42:08');
INSERT INTO `sys_loginfo` VALUES (387, '超级管理员-system', '183.228.88.175', '2023-10-17 15:56:37');
...
CREATE TABLE `sys_notice`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 83 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统公告表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_notice
-- ----------------------------
INSERT INTO `sys_notice` VALUES (57, '面料买一送一', '<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" class=\"layui-table\"><tbody><tr data-index=\"1\" class=\"layui-table-hover\"><td data-field=\"size\" data-key=\"1-0-9\" align=\"center\" class=\"\"><p>面料买一送一[25KG/袋]</p></td><td data-field=\"goodspackage\" data-key=\"1-0-10\" align=\"center\" class=\"\"><div class=\"layui-table-cell laytable-cell-1-0-10\"><br></div></td><td data-field=\"productcode\" data-key=\"1-0-11\" align=\"center\" class=\"\"><div class=\"layui-table-cell laytable-cell-1-0-11\">-货号：<b>SD13156146</b></div></td></tr></tbody></table>&nbsp;2023年12月31日前有效', '2023-10-12 07:57:06', '超级管理员', NULL);
